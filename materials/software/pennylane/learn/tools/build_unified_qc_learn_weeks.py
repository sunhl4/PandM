#!/usr/bin/env python3
"""Merge QC-learn week3 + quantum-chem learning-ms week4/final into one compendium."""
...
# (source_path, anchor, title)
PARTS: list[tuple[pathlib.Path, str, str]] = [
    (QC_LEARN / "week3_classical_ml.md", "ql-w3", "卷 F — 第 3 周：经典 ML × 量子化学"),
    (QC_MS / "week4_quantum_ml.md", "ql-w4", "卷 G — 第 4 周：量子算法与 VQE 深度稿"),
    (QC_MS / "final_project_ideas.md", "ql-proj", "卷 H — 最终项目与创新方向"),
]
...
def main() -> None:
    chunks = [
        ...
        "",
        "> **生成**：`tools/build_unified_qc_learn_weeks.py`。**编辑请改源文件**"
        "（`learning/classical-chem/QC-learn/week3_classical_ml.md`；"
        "`learning/quantum-chem/learning-ms/week4_quantum_ml.md`、`final_project_ideas.md`），再重跑本脚本。",
        "",
        "> **说明**：与「电子结构传统理论」大稿见仓库路径"
        " `learning/classical-chem/QC-learn/quantum_chemistry_foundations.md`（未并入本卷，避免单文件过大）。",
        "",
        "| 原路径 | 跳转 |",
        "|--------|------|",
    ...
    for src_path, anchor, title in PARTS:
