...
For a four-week **written** track on quantum chemistry foundations, classical ML for electronic structure, and quantum algorithms (VQE, mappings, etc.)—merged from the former `QC-learn` repo—see [`../../../learning/classical-chem/QC-learn/README.md`](../../../learning/classical-chem/QC-learn/README.md) (week 4 + project notes live under `learning/quantum-chem/learning-ms/`). That material complements this package’s code-first tutorials under `tutorials/` and `docs/`.
